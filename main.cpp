...
int main() {
    ...
    auto gltf_data = load_gltf("DamagedHelmet.glb");
        ...
        for (const auto& data : gltf_data) {
            runtime.add_object(data.model.vertices, data.model.indices,  data.texture_data, data.texture_width, data.texture_height, data.texture_format);
        }
